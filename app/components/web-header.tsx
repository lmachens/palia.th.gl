...
export default function WebHeader({
  ...
  return (
    <header className="h-[50px] border-b bg-gradient-to-b py-2 border-neutral-800 bg-zinc-800/30 from-inherit">
      <nav className="max-w-7xl px-4 mx-auto flex items-center gap-2 text-sm font-bold overflow-auto">
        <Link
          href="/"
          className="text-lg md:text-2xl font-extrabold tracking-tight whitespace-nowrap hidden sm:block"
        >
        ...
        <Link
          ...
          className={cn(
            "flex whitespace-nowrap items-center gap-1  text-gray-400 px-2 py-1 hover:text-white transition-colors mr-auto",
            {
        ...
        <a
          ...
          target="_blank"
          className="flex whitespace-nowrap items-center bg-[#6974f3]/70 border border-white/10 rounded-md px-2 py-1 hover:bg-[#6974f3] hover:border-white/15 transition-colors"
        >
          ...
          <span className="ml-1 hidden lg:block">Discord</span>
        </a>
        <LocaleSelect />
      </nav>
    </header>
